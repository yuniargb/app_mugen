	...
	<div class="x_content">
		...
		<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
			...
			<div class="form-group">
				<label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama_customer">Nama Customer<span class="err_nama_customer required">*</span>
				</label>
				<div class="col-md-6 col-sm-6 col-xs-12">
					<input type="text" id="nama_customer" required="required" class="form-control col-md-7 col-xs-12"
					...
					success:
						function (data, text)
						{
							if (data.hasil =='true') {
								...
								$(".err_nama_customer").faxtml(data.err_nama_customer).fadeIn('slow');
