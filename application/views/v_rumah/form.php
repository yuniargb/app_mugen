		...
		<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
			...
			<div class="form-group">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<input type="text" id="nama_rumah" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo (isset($default['nama_rumah'])) ? $default['nama_rumah'] : ''; ?>" <?php echo (isset($default['readonly_nama_rumah'])) ? $default['readonly_nama_rumah'] : ''; ?>>
				</div>
			</div>
			<!-- kode_kawasan-->
			<div class="form-group">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<input type="text" id="kode_kawasan" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo (isset($default['kode_kawasan'])) ? $default['kode_kawasan'] : ''; ?>" <?php echo (isset($default['readonly_kode_kawasan'])) ? $default['readonly_kode_kawasan'] : ''; ?>>
				</div>
			</div>
			<!-- kode_blok-->
			<div class="form-group">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<input type="text" id="kode_blok" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo (isset($default['kode_blok'])) ? $default['kode_blok'] : ''; ?>" <?php echo (isset($default['readonly_kode_blok'])) ? $default['readonly_kode_blok'] : ''; ?>>
				</div>
			</div>
			<!-- harga-->
			<div class="form-group">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<input type="text" id="harga" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo (isset($default['harga'])) ? $default['harga'] : ''; ?>" <?php echo (isset($default['readonly_harga'])) ? $default['readonly_harga'] : ''; ?>>
				</div>
			</div>
			<!-- luas_tanah-->
			<div class="form-group">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<input type="text" id="luas_tanah" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo (isset($default['luas_tanah'])) ? $default['luas_tanah'] : ''; ?>" <?php echo (isset($default['readonly_luas_tanah'])) ? $default['readonly_luas_tanah'] : ''; ?>>
				</div>
			</div>
			<!-- luas_bangunan-->
			<div class="form-group">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<input type="text" id="luas_bangunan" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo (isset($default['luas_bangunan'])) ? $default['luas_bangunan'] : ''; ?>" <?php echo (isset($default['readonly_luas_bangunan'])) ? $default['readonly_luas_bangunan'] : ''; ?>>
				</div>
			</div>
			<!-- gambar-->
			<div class="form-group">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<input type="text" id="gambar" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo (isset($default['gambar'])) ? $default['gambar'] : ''; ?>" <?php echo (isset($default['readonly_gambar'])) ? $default['readonly_gambar'] : ''; ?>>
				</div>
			</div>
